...
// OUTRO EXEMPLO, uma funcão dentro de outra função 
                    //2 -> valor de soma()
function imprimeTexto(texto) {
    console.log(texto)
}
...
// o return tem que ser a última linha da função, pois o que for escrito depois do return não será executado, mas você pode escrever depois do return

...
function mergeSort(array, nivelAninhamento = 0) {
  ...
  if(array.length > 1) {
    ...
    // Math.floor serve para arredondar o indice, pois precisamos de numeros inteiros, neste caso queremos dividir em 2, ex: caso ele tenha 5 elementos, ficará 2 e 3.
    ...
    // slice, serve para "fatiar" os arrays.
